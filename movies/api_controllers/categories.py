...
def get_categoris(request, id: UUID4,name :str):
    try:
        catogories =Category.objects.get(id=id)
        return 200, catogories
    except Category.DoesNotExist:
        return 404, {'msg': 'There is no catogories with that id.'}
