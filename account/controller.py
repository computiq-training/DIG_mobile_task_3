...
@account_router.post('/forget-passord/otp', response={200: PasswordResetToken, codes_4xx: MessageOut})
...
@account_router.post('/forget-passord', auth=PasswordResetTokenAuthentication(), response={
    200: AccountOut,
